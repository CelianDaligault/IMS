...
with open("README.md", "w") as f:
    ...
    f.write("## Summary\n")
    f.write("This project uses PySpark to analyze and predict temperatures based on weather data.\n\n")
    f.write("## Results\n")
    f.write("### Temperature\n")
    f.write("![Temperature](temperature_plot.png)\n\n")
    f.write("### Mean Direct Radiation\n")
    f.write("![Direct Radiation](radiation_direct_plot.png)\n\n")
    f.write("### Mean Diffuse Radiation\n")
    f.write("![Diffuse Radiation](radiation_diffuse_plot.png)\n\n")
